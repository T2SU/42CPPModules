...
/*   Updated: 2021/12/02 15:48:31 by smun             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(Form& form)
{
	...
	{
		std::cerr << getName() << " cannot sign " << form.getName() << " because " << ex.what() << std::endl;
	}
}
...
void	Bureaucrat::executeForm(Form const& form)
{
	...
	{
		std::cerr << getName() << " cannot execute " << form.getName() << " because " << ex.what() << std::endl;
	}
}
